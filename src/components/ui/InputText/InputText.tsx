    ...
    return (
      <div className={styles.input}>
        ...
        <div className={styles.wrapper}>
          ...
          />
          {clearable && (
            <Icon name="cross" className={`${styles.icon} ${styles.hover}`} onClick={handleClear} />
          )}
          {type === "password" && <Icon name={isVisible ? 'eyeOff' : 'eye'} className={`${styles.icon} ${styles.hover}`} onClick={toggleVisible}></Icon>}
